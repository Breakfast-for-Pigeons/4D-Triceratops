...
pressed to make the Triceratops move and grunt.
...
def main():
    ...
    pressed. One button will activate the Triceratops and the other
    ...
    try:
        ...
        permission_check()
        # Read the dinosaur_facts.txt file to populate the dino_facts
        # list.
        ...
        while True:
            ...
            if green_button.is_pressed:
                ...
                # Move the Triceratops for the duration of the sound
                # file
...
def file_check():
    ...
    sounds = ['Triceratops1.ogg', 'Triceratops2.ogg', 'Triceratops3.ogg',
              'Triceratops4.ogg', 'Triceratops5.ogg', 'Triceratops6.ogg',
              'Triceratops7.ogg', 'Triceratops8.ogg']
...
def get_grunt():
    ...
    grunt sound files and then return it and its file length to the main
    function.
    '''
...
def activate_triceratops(sound, sound_length):
    '''
    The activate_triceratops function has two parameters: sound and
    sound length.
    ...
    will be one of the randomly selected grunts and its length. This
    ...
    try:
        ...
        logging.error("A bad value was specified for the triceratops_motor." +
