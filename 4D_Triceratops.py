...
def main():
	...
	pressed. One button will activate the Triceratops and the other button 
...
def activate_triceratops(sound, sound_length):
	"""
	The activate_triceratops function has two parameters: sound and sound length.
	...
	one of the randomly selected grunts and its length. This function will play the 
