...
pressed to make the T. rex move and gurnt.
...
def activate_triceratops(sound, sound_length):
    """
    Starts the Triceratops motor

    This function will play the sound file and activate the Triceratops
    motor for the duration of the sound file.

    Arguments:
        sound: The randomly selected Triceratops sound file
